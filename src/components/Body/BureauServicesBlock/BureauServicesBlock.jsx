...
import style from "./BureauServicesBlock.module.css";
import first_item_icon from "../../../assets/first_item_icon.svg";
import second_item_icon from "../../../assets/second_item_icon.svg";
import third_item_icon from "../../../assets/third_item_icon.svg";
import fourth_item_icon from "../../../assets/fourth_item_icon.svg";
import fifth_item_icon from "../../../assets/fifth_item_icon.svg";
import sixth_item_icon from "../../../assets/sixth_item_icon.svg";
import React from "react";
import { useEffect, useState } from "react";

const BureauServicesBlock = () => {
  ...
  useEffect(() => {
    ...
    scrollBlock.addEventListener("scroll", () => {
      if (
        window.innerWidth + scrollBlock.scrollLeft >=
        scrollBlock.scrollWidth
      ) {
  ...
  return (
    <div className={style["block"]} id="bureau-block">
      <div className={style["block-margin"]}/>
      <div className={style["bureau-services-block"]} >
        <span className={style["block-title"]}>Oferta biura rachunkowego</span>
        <div className={style["content"]} id="scroll-block">
          {items.map((el) => (
            <BlockItemCard
              icon={el["icon"]}
              title={el["title"]}
        ...
        <div className={style["nav-block"]}>
          <div className={style["nav-block__content"]}>
            <button
              className={style["nav-block__btn"]}
            ...
            >
              ...
              >
                <path
                  ...
                  fill={prevButtonState ? "#282828" : "#CFCFCF"}
                />
              </svg>
            </button>
            <button
            ...
            >
              ...
              >
                <path
                  ...
                  fill={nextButtonState ? "#282828" : "#CFCFCF"}
                />
              </svg>
            </button>
          </div>
...
export default BureauServicesBlock;
