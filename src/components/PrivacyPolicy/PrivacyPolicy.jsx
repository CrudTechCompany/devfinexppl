  ...
  return (
    <div className={style["block"]}>
      <div className={style["content"]}>
        ...
        <ul>
          <li>
            <b>Serwis</b> - serwis internetowy "Finance Expert" działający pod
            adresem finexp.pl
          </li>
          <li>
          ...
          <li>
            <b>Administrator Serwisu / Danych</b> - Administratorem Serwisu oraz
            Administratorem Danych (dalej Administrator) jest firma Finance
            Expert Sp. z o.o., prowadząca działalność pod adresem: ul. Krupnicza
            2-4/31, 50-074 Wroclaw, o nadanym numerze identyfikacji podatkowej
            (NIP): 8971906842, świadcząca usługi drogą elektroniczną za
          ...
          <li>
            <b>Urządzenie </b>- elektroniczne urządzenie wraz z oprogramowaniem,
          ...
          <li>
            <b>Dane osobowe</b> - oznaczają informacje o zidentyfikowanej lub
          ...
          <li>
            <b>Przetwarzanie </b>- oznacza operację lub zestaw operacji
            wykonywanych na danych osobowych lub zestawach danych osobowych w
            sposób zautomatyzowany lub niezautomatyzowany, taką jak zbieranie,
          ...
          <li>
            <b>Zgoda </b>- zgoda osoby, której dane dotyczą oznacza dobrowolne,
            ...
            potwierdzającego, przyzwala na przetwarzanie dotyczących jej danych
            osobowych
          </li>
          <li>
            ...
            zniszczenia, utracenia, zmodyfikowania, nieuprawnionego ujawnienia
            lub nieuprawnionego dostępu do danych osobowych przesyłanych,
            przechowywanych lub w inny sposób przetwarzanych
          </li>
          <li>
            <b>Pseudonimizacja </b>- oznacza przetworzenie danych osobowych w
            taki sposób, by nie można ich było już przypisać konkretnej osobie,
            ...
            objęte środkami technicznymi i organizacyjnymi uniemożliwiającymi
            ich przypisanie zidentyfikowanej lub możliwej do zidentyfikowania
            osobie fizycznej
          </li>
          <li>
            <b>Anonimizacja </b>- Anonimizacja danych to nieodwracalny proces
        ...
        <ul>
          <li>
            <b>Mechanizmy składowania i odczytu plików Cookie</b> - Mechanizmy
          ...
          <li>
            <b>Cookie wewnętrzne</b> - zastosowane przez Administratora pliki
            Cookie są bezpieczne dla Urządzeń Użytkowników i nie zawierają
            skryptów, treści lub informacji mogących zagrażać bezpieczeństwu
            danych osobowych lub bezpieczeństwu Urządzenia z którego korzysta
            Użytkownik.
          </li>
          <li>
            <b>Cookie zewnętrzne</b> - Administrator dokonuje wszelkich
            możliwych działań w celu weryfikacji i doboru partnerów serwisu w
            kontekście bezpieczeństwa Użytkowników. Administrator do współpracy
            dobiera znanych, dużych partnerów o globalnym zaufaniu społecznym.
            Nie posiada on jednak pełnej kontroli nad zawartością plików Cookie
          ...
          <li>
            ...
            danych umieszczanych w plikach Cookie. Należy jednak zwrócić uwagę,
            że zapewnienie bezpieczeństwa tych danych zależy od obu stron w tym
          ...
          <li>
            <b>Przechowywanie danych osobowych</b> - Administrator zapewnia, że
        ...
        <ul>
          <li>
            <span>Realizacji usług elektronicznych:</span>
            <ul>
              <li>
        ...
        <ul>
          <li>
            <b>Adres pocztowy </b>
            <span>– ul. Krupnicza 2-4/31, 50-074 Wroclaw</span>
          </li>
          <li>
